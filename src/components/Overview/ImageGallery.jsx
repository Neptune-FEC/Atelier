        ...
        <div className="gallery-overlay">
          <div className="thumbnail-panel">
            ...
            <div className="thumbnail-container">
              <div className="thumbnail-items" style={{ height: `${100 * (this.numPhotos / 3)}%` }}>
                {this.photos.map((photo, idx) => <div id={`id${idx}`} className="thumbnail-item" style={{ backgroundImage: `url(${photo.thumbnail_url})`, height: `${100 / (this.numPhotos / 3)}%` }} />)}
              </div>
            </div>
